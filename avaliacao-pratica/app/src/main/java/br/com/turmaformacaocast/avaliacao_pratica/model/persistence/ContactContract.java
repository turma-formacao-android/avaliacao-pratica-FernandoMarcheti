...
public final class ContactContract {
    ...
    public static final String[] COLUMNS = { ID, NAME, PHONE_ID, EMAIL_ID, SOCIALNETWORK_ID, ADDRESS_ID, WEB_ID };
    ...
    public static String getCreateTableScript() {
        ...
        create.append(PHONE_ID + " INTEGER NOT NULL, " );
        create.append(EMAIL_ID + " INTEGER, " );
        create.append(SOCIALNETWORK_ID + " INTEGER, " );
